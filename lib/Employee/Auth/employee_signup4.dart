            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                if (count == 0) {
                  ...
                  if (driver == true) temp.add("Driver");
                  if (halwai == true) temp.add("Halwai");
                  if (peon == true) temp.add("Peon");
                  if (tutor == true) temp.add("Tutor");
                  if (securityguard == true) temp.add("Security Guard");
                  if (labour == true) temp.add("Labour");
                  if (waiter == true) temp.add("Waiter");
                  if (maid == true) temp.add("Maid");
                  if (watchman == true) temp.add("Watchman");
                  if (deliveryBoy == true) temp.add("Delivery Boy");
                  result = temp.toList();
